...
export default defineConfig({
    ...
    themeConfig: {
        ...
        nav: [
          { text: 'Home', link: '/' },
          { text: 'Guide', link: '/v1/introduction/what-is-geo' },
        ],
        ...
        sidebar: [
            {
                text: 'Introduction',
                items: [
                    { text: 'What is Guidelines', link: '/v1/introduction/what-is-geo' },
                ]
            },
        ...
        socialLinks: [
            { icon: 'github', link: 'https://github.com/yormy/geo-laravel' }
        ]
      }
